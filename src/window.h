...
#define draw_triangle(p1, p2, p3, c1, c2, c3) window_renderer_triangle(&(window_renderer), (p1), (p2), (p3), (c1), (c2), (c3))
...
WINDOW_DEF void window_renderer_vertex(Window_Renderer *r, Window_Renderer_Vec2f p, Window_Renderer_Vec4f c);
WINDOW_DEF void window_renderer_triangle(Window_Renderer *r, Window_Renderer_Vec2f p1, Window_Renderer_Vec2f p2, Window_Renderer_Vec2f p3, Window_Renderer_Vec4f c1, Window_Renderer_Vec4f c2, Window_Renderer_Vec4f c3);
...
WINDOW_DEF void window_renderer_triangle(Window_Renderer *r, Window_Renderer_Vec2f p1, Window_Renderer_Vec2f p2, Window_Renderer_Vec2f p3, Window_Renderer_Vec4f c1, Window_Renderer_Vec4f c2, Window_Renderer_Vec4f c3) {
    window_renderer_vertex(r, p1, c1);
    window_renderer_vertex(r, p2, c2);
    window_renderer_vertex(r, p3, c3);    
}
