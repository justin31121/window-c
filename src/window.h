...
#define draw_texture_colored(p, s, uvp, uvs, c) window_renderer_texture_colored(&(window_renderer), (p), (s), (uvp), (uvs), (c))
...
WINDOW_DEF void window_renderer_texture_colored(Window_Renderer *r, Window_Renderer_Vec2f p, Window_Renderer_Vec2f s, Window_Renderer_Vec2f uvp, Window_Renderer_Vec2f uvs, Window_Renderer_Vec4f c);
...
static const char *window_renderer_fragment_shader_source=
    ...
    "        color = (vec4(1, 1, 1, 0) + color) * out_color;\n"
    "        fragColor = color;\n"
    "    }\n"
    "}\n";
